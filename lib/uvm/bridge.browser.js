...
module.exports = function (bridge, options, callback) {
    var id = uuid(),
        ...
        escapedBridgeCode = unescape(encodeURIComponent(sandboxCode(code, id))),
    ...
    iframe.setAttribute('src', 'data:text/html;base64, ' + btoa(escapedBridgeCode));
    ...
    iframe.setAttribute('srcdoc', escapedBridgeCode);
